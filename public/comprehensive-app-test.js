...
// Function to launch comprehensive test UI (don't auto-run)
function launchComprehensiveTestSuite() {
...
if (typeof window !== 'undefined') {
    window.launchComprehensiveTestSuite = launchComprehensiveTestSuite;
}
